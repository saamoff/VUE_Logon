<template>
  ...
  <h6 v-else-if="control === '6'" :class="{contentHomeTitle:contentHome1, contentHome:contentHome2, clockClass:clock, loginTitle:titleLogin, detailsLogin:titleDetails}">{{ text }}</h6>
</template>
